# Ciencia 2k26 Backend Architecture Overview

## Introduction

Ciencia 2k26 is an open-source event management and ticketing platform built with Laravel. The backend implements a **Domain-Driven Design (DDD)** architecture with clear separation of concerns, enabling maintainable, testable, and scalable code.
...
Ciencia 2k26 implements account-based multi-tenancy:
