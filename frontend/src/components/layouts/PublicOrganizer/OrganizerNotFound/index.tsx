...
export const OrganizerNotFound = () => {
    return (
        <GenericErrorPage
            ...
            buttonUrl="https://app.ticketing.ciencia2k26.qzz.io/auth/register?utm_source=app.ticketing.ciencia2k26.qzz.io&utm_content=organizer-not-found/create-event"
