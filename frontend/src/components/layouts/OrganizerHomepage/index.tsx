                    ...
                    <div className={classes.wrapper}>
                        ...
                        <div className={classes.footerSection}>
                            <div className={classes.footerLinks}>
                                <Anchor
                                    href={getConfig('VITE_PRIVACY_URL', 'https://ticketing.ciencia2k26.qzz.io/privacy-policy?utm_source=app-organizer-footer')}
                                ...
                                <Anchor
                                    href={getConfig('VITE_TOS_URL', 'https://ticketing.ciencia2k26.qzz.io/terms-of-service?utm_source=app-organizer-footer')}
                                    className={classes.footerLink}
                                >
                                    {t`Terms of Service`}
                                </Anchor>
