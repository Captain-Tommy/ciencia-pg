                ...
                <form onSubmit={form.onSubmit(handleSubmit)}>
                    <fieldset disabled={!isFetched}>
                        ...
                        <Checkbox
                            ...
                            label={(
                                <Trans>
                                    ...
                                    <Anchor
                                        target={'_blank'}
                                        href={getConfig("VITE_TOS_URL", 'https://ticketing.ciencia2k26.qzz.io/terms-of-service')}
                                    >
                        ...
                        <Checkbox
                            ...
                            label={<Trans>Receive product updates from {getConfig("VITE_APP_NAME", "Ciencia 2k26")}.</Trans>}
                        />
