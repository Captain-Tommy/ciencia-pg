            ...
            <Container size="sm" className={classes.welcomeContent}>
                <div className={classes.welcomeHeader}>
                    <div className={classes.logo}>
                        <img src={getConfig("VITE_APP_LOGO_LIGHT", "/logos/ticketing.ciencia2k26.qzz.io-text-dark.svg")} alt={`${getConfig("VITE_APP_NAME", "Ciencia 2k26")} logo`} className={classes.logo}/>
                    </div>
                    <h1 className={classes.welcomeTitle}>
                        <Trans>
                            Welcome to {getConfig("VITE_APP_NAME", "Ciencia 2k26")}, {userData?.first_name} 👋
                        </Trans>
                    </h1>
                </div>
