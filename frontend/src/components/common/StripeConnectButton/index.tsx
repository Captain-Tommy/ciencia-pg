...
import { isCiencia } from '../../../utilites/helpers';
...
export const StripeConnectButton: React.FC<StripeConnectButtonProps> = ({
    ...
    // For Ciencia 2k26, use the new platform parameter for Ireland migration
    // For open-source, use existing logic (no platform parameter)
    const platformToUse = isCiencia() ? platform || 'ie' : undefined;
